export const homeObjOne = {
    ...
    imgStart: false,
    img: require('../../../images/expertises.jpg'),
    alt: 'Car',
    dark: true,
    primary: true,
    darkText: false,
  ...
  export const homeObjTwo = {
    ...
    lightText: false,
    lightTextDesc: true,
    topLine: 'Rhea in Motion',
    headline: 'Re-development of legacy applications',
    description:
